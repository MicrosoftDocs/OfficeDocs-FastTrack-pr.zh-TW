...
- FastTrack Center 會在 Azure 中設立移轉環境。
    
- FastTrack Center 會在內部部署系統管理工作站上，設定移轉工具。
    
- FastTrack Center 會設定並示範如何使用自動匯入工具。
    
- FastTrack Center 會進行所有移轉元件的驗證，並執行測試移轉。
...
- FastTrack Center 執行試驗與快速移轉。 
    
- FastTrack Center 執行移轉事件和 T-minus 活動。
    
- FastTrack Center 提供移轉後協助。
