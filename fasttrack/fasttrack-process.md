...
- FastTrack 團隊可提供指引，以利核心和服務上架以及規劃成功的合格服務採用。
    
- FastTrack 專家在遠端提供所有上架、移轉以及使用者採用服務。
    
- FastTrack 專家將使用工具和發行的說明文件組合，從遠端協助您。
    
- FastTrack Center 會提供協助，並且是在指定地區的一般上班時段提供。
    
- 協助提供的語言有：繁體中文和簡體中文 (僅限說中文的資源)、英文、法文、德文、義大利文、日文、韓文、葡萄牙文 (巴西)、西班牙文、泰文以及越南文。
    
-  FastTrack 專家可直接與您或您的代表配合。 
    
- FastTrack 專家會提供電子郵件和資料移轉指引。
